...
from .timing import calculate_extended_delete_time, format_extension_message, EXTENSION_HOURS
...
class EventsMixin:
    ...
    async def on_raw_reaction_add(self, payload: discord.RawReactionActionEvent):
        ...
        async with self._config_lock:
            ...
            new_delete_time = calculate_extended_delete_time(current_delete_time)
        ...
        if text_channel_id:
            ...
            if text_channel:
                try:
                    ...
                    extension_msg = format_extension_message(user_mention, hours, minutes)
